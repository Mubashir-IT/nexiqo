    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div className="bg-white rounded- shadow-xl max-w-full mx-auto min-h-full flex flex-col">
              {/* Header */}
                      ...
                      <div className="flex gap-2 mt-3 overflow-x-auto pb-2">
                        {projectImages.map((img, index) => (
                          <button
                            ...
                            className={`flex-shrink-0 w-24 h-16 rounded-lg overflow-hidden border-2 transition-all ${currentImageIndex === index
